...
function Cart() {
    ...
    const onRemoveCartItem=(id,price,count)=>{
        if(window.confirm('Are you sure???'))
        {
            dispatch(removeCartItem(id,price,count));
        }
    }

    const onPlusCartItem=(id,price)=>{
        dispatch(plusCartItem(id,price));
    }
    const onMinusCartItem=(id,price)=>{
        ...
        <div className="container container--cart">
            {totalCount ? <div className="cart">
                ...
                <div className="content__items">
                    {
                        addedPizzas.map((obj, index) => <CartItem key={index} onRemove={onRemoveCartItem} onPlus={onPlusCartItem} onMinus={onMinusCartItem} countPizzas={items[obj.id].length} {...obj}  />)
                    }
